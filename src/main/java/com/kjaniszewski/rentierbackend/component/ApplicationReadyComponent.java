...
public class ApplicationReadyComponent {
    ...
    private void InitializePayments(){
        ...
        Payment payment1 = new Payment(Date.valueOf("2020-05-01"), new BigDecimal(400.0), PaymentType.CHARGED);
        payment1.setLocation(loc1);
        payment1.setTenant(ten1);
        Payment payment2 = new Payment(Date.valueOf("2020-06-01"), new BigDecimal(400.0), PaymentType.FORECAST);
        payment2.setLocation(loc1);
        payment2.setTenant(ten1);
        Payment payment3 = new Payment(Date.valueOf("2020-07-01"), new BigDecimal(400.0), PaymentType.FORECAST);
        payment3.setLocation(loc1);
        payment3.setTenant(ten1);
        Payment payment4 = new Payment(Date.valueOf("2020-05-01"), new BigDecimal(350.0), PaymentType.CHARGED);
        payment4.setLocation(loc2);
        payment4.setTenant(ten2);
        Payment payment5 = new Payment(Date.valueOf("2020-06-01"), new BigDecimal(750.0), PaymentType.FORECAST);
        payment5.setLocation(loc2);
        payment5.setTenant(ten2);
        Payment payment6 = new Payment(Date.valueOf("2020-07-01"), new BigDecimal(450.0), PaymentType.FORECAST);
    ...
    private void InitializeBills(){
        ...
        Bill bill1 = new Bill(Date.valueOf("2020-05-01"), new BigDecimal(306.73), BillType.PAID);
        Location loc1 = locationRepo.findById(1L).orElse(null);
        BillGroup group1 = billGroupRepo.findById(1L).orElse(null);
        bill1.setLocation(loc1);
        bill1.setBillGroup(group1);
        Bill bill2 = new Bill(Date.valueOf("2020-05-01"), new BigDecimal(63.33), BillType.PAID);
        BillGroup group3 = billGroupRepo.findById(3L).orElse(null);
        bill2.setLocation(loc1);
        bill2.setBillGroup(group3);
        Bill bill3 = new Bill(Date.valueOf("2020-06-01"), new BigDecimal(268.32), BillType.REAL);
        bill3.setLocation(loc1);
        bill3.setBillGroup(group1);

        Bill bill4 = new Bill(Date.valueOf("2020-05-01"), new BigDecimal(322.01), BillType.PAID);
        Location loc2 = locationRepo.findById(2L).orElse(null);
        bill4.setLocation(loc2);
        bill4.setBillGroup(group1);
        Bill bill5 = new Bill(Date.valueOf("2020-05-01"), new BigDecimal(19.46), BillType.PAID);
        BillGroup group4 = billGroupRepo.findById(4L).orElse(null);
        bill5.setLocation(loc2);
        bill5.setBillGroup(group4);

        Bill bill6 = new Bill(Date.valueOf("2020-05-01"), new BigDecimal(256.33), BillType.PAID);
        Location loc3 = locationRepo.findById(3L).orElse(null);
        bill6.setLocation(loc3);
        bill6.setBillGroup(group1);

        Bill bill7 = new Bill(Date.valueOf("2020-05-01"), new BigDecimal(19.38), BillType.PAID);
        bill7.setLocation(loc1);
        bill7.setBillGroup(group4);
        Bill bill8 = new Bill(Date.valueOf("2020-06-01"), new BigDecimal(63.33), BillType.REAL);
        bill8.setLocation(loc1);
        bill8.setBillGroup(group3);
        Bill bill9 = new Bill(Date.valueOf("2020-06-01"), new BigDecimal(19.38), BillType.REAL);
        bill9.setLocation(loc1);
        bill9.setBillGroup(group4);
        Bill bill10 = new Bill(Date.valueOf("2020-07-01"), new BigDecimal(268.32), BillType.REAL);
        bill10.setLocation(loc1);
        bill10.setBillGroup(group1);
        Bill bill11 = new Bill(Date.valueOf("2020-07-01"), new BigDecimal(63.33), BillType.REAL);
        bill11.setLocation(loc1);
        bill11.setBillGroup(group3);
        Bill bill12 = new Bill(Date.valueOf("2020-07-01"), new BigDecimal(19.38), BillType.REAL);
        bill12.setLocation(loc1);
        bill12.setBillGroup(group4);
        Bill bill13 = new Bill(Date.valueOf("2020-08-01"), new BigDecimal(268.32), BillType.FORECAST);
        bill13.setLocation(loc1);
        bill13.setBillGroup(group1);
        Bill bill14 = new Bill(Date.valueOf("2020-08-01"), new BigDecimal(63.33), BillType.FORECAST);
        bill14.setLocation(loc1);
        bill14.setBillGroup(group3);
        Bill bill15 = new Bill(Date.valueOf("2020-08-01"), new BigDecimal(19.38), BillType.FORECAST);
